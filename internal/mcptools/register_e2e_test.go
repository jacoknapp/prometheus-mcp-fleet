...
func TestRegisteredToolsProduceBusinessErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{ToolQueryExemplars, map[string]any{"cluster": badCluster, "query": "up"}, CodeUnknownCluster},
		...
		{ToolTargetMetadata, map[string]any{"cluster": badCluster}, CodeUnknownCluster},
		...
		{ToolAlertmanagers, map[string]any{"cluster": badCluster}, CodeUnknownCluster},
